      ...
      <Container>
        <div className="relative mx-auto hidden h-[420px] max-w-[1200px] lg:flex items-center justify-center">
          ...
          <div className="absolute left-0 h-[320px] w-[280px]">
            <div
              className="absolute inset-0 bg-[#0D7FA3] rounded-[40px]"
            ...
            <div className="absolute left-[35%] top-[112px] rounded-[16px_16px_3px_16px] bg-[#00AEEF] px-4 py-2.5 text-[14px] font-semibold text-white shadow-[0_10px_24px_-12px_rgba(0,120,160,0.45)]">
              Just send the Draft
            </div>
          </div>
          ...
          <div className="absolute left-1/2 -translate-x-1/2 h-[340px] w-[280px] flex flex-col items-center justify-center">
            <div className="relative h-[300px] w-[280px]">
              <div className="absolute inset-0 bg-[#0D7FA3] rounded-[60px]" />
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
            ...
            <div className="absolute top-[32px] right-[-40px] rounded-full bg-white px-4 py-2 text-[14px] font-semibold text-[#0D7FA3] shadow-[0_10px_24px_-12px_rgba(0,60,90,0.3)]">
              Thanks! ✋
            </div>
          </div>
